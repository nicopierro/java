...
public class Esercizio3 {
    ...
    public static void main(String[] args) {
        ...
        int classe, KW, eta = 0, superbollo = 0;
        double bollo = 0;
        ...
        if ((classe >= 0 && classe < 7) && KW > 0 ) {
            ...
            System.out.println("Attenzione, i valori della classe ambientale vanno da 0 a 6 e il valore dei KW deve essere maggiori di zero.");
        }
        ...
        if (KW > 185 ) {
            if (eta < 0) {
                System.out.println("Attenzione, l'età della propria automobile non può essere negativa.");
            } else if(eta >= 0 && eta <= 5) {
                superbollo = 20;
        ...
        if (KW > 185 ) {
             if (eta < 0) {
        System.out.println("Il bollo da pagare per un'auto da " + KW + " in classe ambientale " + classe + " è di " + bollo + " euro. Il superbollo da pagare per un'auto di " + eta + " anni è di " + superbollo + " euro.");
            }
        }
